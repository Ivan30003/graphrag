...
from .base_model_formats import text_decomposition, relationship_reconstraction, High_level_element,decomposed_text
...
from .attribute_generation import attribute_generation_prompt, attribute_generation_prompt_Chinese
from .community_summary import community_summary, community_summary_Chinese
from .decompose_query import decompos_query,decompos_query_Chinese
from .answer_question import answer_prompt, answer_prompt_Chinese
